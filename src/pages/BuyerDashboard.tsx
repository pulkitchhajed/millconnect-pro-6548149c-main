        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-2">
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <Button asChild variant="ghost" size="sm"><Link to="/orders">View All <ArrowRight className="ml-1 h-3 w-3" /></Link></Button>
            </div>
            {recentOrders.length === 0 ? (
              <p className="text-muted-foreground text-sm">No orders yet. <Link to="/catalog" className="text-primary underline">Browse catalog</Link></p>
            ) : (
